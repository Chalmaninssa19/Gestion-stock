...
<div class="row">
     <div class="col-md-6 grid-margin stretch-card">
          <div class="card">
               <div class="card-body">
                    <h4 class="card-title">Saisie de sortie de stock</h4>
                    <form class="forms-sample" action="SaisieOut" method="POST">
                        ...
                        <button type="submit" class="btn btn-gradient-primary me-2">Sortir</button>
                    </form>
